...
public class PhelReaderConditionalImpl extends ASTWrapperPsiElement implements PhelReaderConditional {

  public PhelReaderConditionalImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PhelVisitor visitor) {
    visitor.visitReaderConditional(this);
  }
