...
public class PhelReaderConditionalSpliceImpl extends ASTWrapperPsiElement implements PhelReaderConditionalSplice {

  public PhelReaderConditionalSpliceImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PhelVisitor visitor) {
    visitor.visitReaderConditionalSplice(this);
  }
