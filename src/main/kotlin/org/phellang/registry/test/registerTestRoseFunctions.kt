...
""",
            ...
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.47.0/src/phel/test/rose.phel#L213",
                docs = "",
            ),
        ),
    ),
...
""",
            example = null,
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.47.0/src/phel/test/rose.phel#L220",
                docs = "",
            ),
        ),
    ),
    PhelFunction(
        ...
        documentation = DocumentationInfo(
            summary = """
Monadic bind. <code>f</code> takes a value and returns a rose tree; the resulting tree combines the shrinks of <code>t</code> (each fed through <code>f</code>) with the shrinks produced by <code>f</code> on the root.
""",
            example = "(rose-bind (rose-pure 1) (fn [n] (rose-pure (inc n))))",
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.47.0/src/phel/test/rose.phel#L103",
                docs = "",
            ),
        ),
    ),
    PhelFunction(
        ...
        documentation = DocumentationInfo(
            ...
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.47.0/src/phel/test/rose.phel#L70",
                docs = "",
            ),
        ),
    ),
...
""",
            ...
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.47.0/src/phel/test/rose.phel#L117",
                docs = "",
            ),
        ),
    ),
    PhelFunction(
        ...
        documentation = DocumentationInfo(
            summary = """
Applies <code>f</code> to every value in rose tree <code>t</code> (the root and, lazily, every descendant).
""",
            example = "(rose-fmap inc (rose-pure 1)) ; root = 2",
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.47.0/src/phel/test/rose.phel#L94",
                docs = "",
            ),
        ),
    ),
    PhelFunction(
        ...
        documentation = DocumentationInfo(
            ...
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.47.0/src/phel/test/rose.phel#L130",
                docs = "",
            ),
        ),
    ),
...
""",
            example = "(rose-map [...])",
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.47.0/src/phel/test/rose.phel#L297",
                docs = "",
            ),
        ),
    ),
...
""",
            ...
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.47.0/src/phel/test/rose.phel#L49",
                docs = "",
            ),
        ),
    ),
...
""",
            ...
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.47.0/src/phel/test/rose.phel#L63",
                docs = "",
            ),
        ),
    ),
...
""",
            ...
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.47.0/src/phel/test/rose.phel#L77",
                docs = "",
            ),
        ),
    ),
    PhelFunction(
        ...
        documentation = DocumentationInfo(
            ...
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.47.0/src/phel/test/rose.phel#L280",
                docs = "",
            ),
        ),
    ),
    PhelFunction(
        ...
        documentation = DocumentationInfo(
            summary = """
Rose tree constructor. <code>children</code> should be a lazy sequence of rose trees (or any seqable value).
""",
            example = "(rose-tree 1 (list (rose-pure 0)))",
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.47.0/src/phel/test/rose.phel#L56",
                docs = "",
            ),
        ),
    ),
...
""",
            ...
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.47.0/src/phel/test/rose.phel#L253",
                docs = "",
            ),
        ),
    ),
    PhelFunction(
        ...
        documentation = DocumentationInfo(
            summary = """
Like <code>rose-vector</code> but preserves original length; only shrinks each element in place (no removal).
""",
            example = null,
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.47.0/src/phel/test/rose.phel#L266",
                docs = "",
            ),
        ),
    ),
...
""",
            ...
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.47.0/src/phel/test/rose.phel#L160",
                docs = "",
            ),
        ),
    ),
...
""",
            ...
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.47.0/src/phel/test/rose.phel#L84",
                docs = "",
            ),
        ),
    ),
    PhelFunction(
        ...
        documentation = DocumentationInfo(
            summary = """
Shrink strategy toward zero: halving steps (<code>n/2</code>, <code>n/4</code>, …) and then decrement toward zero.
""",
            example = "(shrink-int 8)",
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.47.0/src/phel/test/rose.phel#L200",
                docs = "",
            ),
        ),
    ),
...
""",
            ...
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.47.0/src/phel/test/rose.phel#L180",
                docs = "",
            ),
        ),
    )
