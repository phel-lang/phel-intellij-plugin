...
internal fun registerMockFunctions(): List<PhelFunction> = listOf(
    PhelFunction(
        ...
        documentation = DocumentationInfo(
            ...
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.53.0/src/phel/mock.phel#L107",
                docs = "",
            ),
        ),
    ),
    PhelFunction(
        ...
        documentation = DocumentationInfo(
            ...
            example = "(def my-mock (mock :result))",
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.53.0/src/phel/mock.phel#L126",
                docs = "",
            ),
        ),
    ),
    PhelFunction(
        ...
        documentation = DocumentationInfo(
            ...
            example = "(def my-mock (mock :result))",
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.53.0/src/phel/mock.phel#L132",
                docs = "",
            ),
        ),
    ),
    PhelFunction(
        ...
        documentation = DocumentationInfo(
            ...
            example = "(def my-mock (mock :result))",
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.53.0/src/phel/mock.phel#L119",
                docs = "",
            ),
        ),
    ),
    PhelFunction(
        ...
        documentation = DocumentationInfo(
            ...
            example = "(def my-mock (mock :result))",
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.53.0/src/phel/mock.phel#L113",
                docs = "",
            ),
        ),
    ),
    PhelFunction(
        ...
        documentation = DocumentationInfo(
            ...
            example = "(def my-mock (mock :result))",
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.53.0/src/phel/mock.phel#L98",
                docs = "",
            ),
        ),
    ),
...
""",
            ...
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.53.0/src/phel/mock.phel#L168",
                docs = "",
            ),
        ),
    ),
    PhelFunction(
        ...
        documentation = DocumentationInfo(
            ...
            example = "(def my-mock (mock :result))",
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.53.0/src/phel/mock.phel#L150",
                docs = "",
            ),
        ),
    ),
    PhelFunction(
        ...
        documentation = DocumentationInfo(
            ...
            example = "(def my-mock (mock :result))",
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.53.0/src/phel/mock.phel#L144",
                docs = "",
            ),
        ),
    ),
    PhelFunction(
        ...
        documentation = DocumentationInfo(
            ...
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.53.0/src/phel/mock.phel#L30",
                docs = "",
            ),
        ),
    ),
    PhelFunction(
        ...
        documentation = DocumentationInfo(
            ...
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.53.0/src/phel/mock.phel#L41",
                docs = "",
            ),
        ),
    ),
...
""",
            ...
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.53.0/src/phel/mock.phel#L59",
                docs = "",
            ),
        ),
    ),
    PhelFunction(
        ...
        documentation = DocumentationInfo(
            ...
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.53.0/src/phel/mock.phel#L78",
                docs = "",
            ),
        ),
    ),
    PhelFunction(
        ...
        documentation = DocumentationInfo(
            ...
            example = null,
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.53.0/src/phel/mock.phel#L93",
                docs = "",
            ),
        ),
    ),
    PhelFunction(
        ...
        documentation = DocumentationInfo(
            ...
            example = "(def my-mock (mock :result))",
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.53.0/src/phel/mock.phel#L138",
                docs = "",
            ),
        ),
    ),
...
""",
            example = "(def my-mock (mock :result))",
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.53.0/src/phel/mock.phel#L156",
                docs = "",
            ),
        ),
    ),
...
""",
            ...
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.53.0/src/phel/mock.phel#L52",
                docs = "",
            ),
        ),
    ),
...
""",
            ...
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.53.0/src/phel/mock.phel#L214",
                docs = "",
            ),
        ),
    ),
...
""",
            example = null,
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.53.0/src/phel/mock.phel#L178",
                docs = "",
            ),
        ),
    )
