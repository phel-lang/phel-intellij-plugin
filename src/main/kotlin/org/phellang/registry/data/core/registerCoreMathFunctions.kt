...
""",
            ...
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.53.0/src/phel/core/math.phel#L349",
                docs = "",
            ),
        ),
    ),
...
""",
            example = "(* 2 3 4) ; =&gt; 24",
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.53.0/src/phel/core/math.phel#L275",
                docs = "",
            ),
        ),
    ),
...
""",
            example = "(*' 2 3) ; =&gt; 6",
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.53.0/src/phel/core/math.phel#L410",
                docs = "",
            ),
        ),
    ),
...
""",
            example = "(** 2 8) ; =&gt; 256",
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.53.0/src/phel/core/math.phel#L361",
                docs = "",
            ),
        ),
    ),
...
""",
            example = "(+ 1 2 3) ; =&gt; 6",
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.53.0/src/phel/core/math.phel#L221",
                docs = "",
            ),
        ),
    ),
...
""",
            example = "(+' 1 2) ; =&gt; 3",
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.53.0/src/phel/core/math.phel#L391",
                docs = "",
            ),
        ),
    ),
...
""",
            example = "(- 10 3 2) ; =&gt; 5\n(- 4) ; =&gt; -4",
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.53.0/src/phel/core/math.phel#L248",
                docs = "",
            ),
        ),
    ),
...
""",
            example = "(-' 5 2) ; =&gt; 3",
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.53.0/src/phel/core/math.phel#L402",
                docs = "",
            ),
        ),
    ),
...
""",
            example = "(/ 1 2) ; =&gt; 1/2\n(/ 10 2) ; =&gt; 5",
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.53.0/src/phel/core/math.phel#L302",
                docs = "",
            ),
        ),
    ),
    PhelFunction(
        ...
        documentation = DocumentationInfo(
            ...
            example = null,
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.53.0/src/phel/core/math.phel#L217",
                docs = "",
            ),
        ),
    ),
...
""",
            ...
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.53.0/src/phel/core/math.phel#L505",
                docs = "",
            ),
        ),
    ),
...
""",
            example = "(abs -5) ; =&gt; 5",
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.53.0/src/phel/core/math.phel#L526",
                docs = "",
            ),
        ),
    ),
...
""",
            ...
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.53.0/src/phel/core/math.phel#L883",
                docs = "",
            ),
        ),
    ),
...
""",
            ...
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.53.0/src/phel/core/math.phel#L869",
                docs = "",
            ),
        ),
    ),
...
""",
            ...
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.53.0/src/phel/core/math.phel#L1002",
                docs = "",
            ),
        ),
    ),
...
""",
            ...
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.53.0/src/phel/core/math.phel#L862",
                docs = "",
            ),
        ),
    ),
...
""",
            ...
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.53.0/src/phel/core/math.phel#L1018",
                docs = "",
            ),
        ),
    ),
    PhelFunction(
        ...
        documentation = DocumentationInfo(
            ...
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.53.0/src/phel/core/math.phel#L68",
                docs = "",
            ),
        ),
    ),
    PhelFunction(
        ...
        documentation = DocumentationInfo(
            summary = """
Bitwise <code>and</code> with the complement of each subsequent argument: <code>(bit-and-not x y)</code> is <code>x & ~y</code>. Additional arguments are folded in left to right, clearing every bit that is set in any of them.
""",
            example = "(bit-and-not 0xFF 0x0F) ; =&gt; 240",
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.53.0/src/phel/core/math.phel#L167",
                docs = "",
            ),
        ),
    ),
...
""",
            ...
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.53.0/src/phel/core/math.phel#L192",
                docs = "",
            ),
        ),
    ),
...
""",
            ...
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.53.0/src/phel/core/math.phel#L199",
                docs = "",
            ),
        ),
    ),
    PhelFunction(
        ...
        documentation = DocumentationInfo(
            ...
            example = "(bit-not 0) ; =&gt; -1",
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.53.0/src/phel/core/math.phel#L128",
                docs = "",
            ),
        ),
    ),
    PhelFunction(
        ...
        documentation = DocumentationInfo(
            ...
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.53.0/src/phel/core/math.phel#L88",
                docs = "",
            ),
        ),
    ),
...
""",
            ...
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.53.0/src/phel/core/math.phel#L185",
                docs = "",
            ),
        ),
    ),
    PhelFunction(
        ...
        documentation = DocumentationInfo(
            ...
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.53.0/src/phel/core/math.phel#L137",
                docs = "",
            ),
        ),
    ),
    PhelFunction(
        ...
        documentation = DocumentationInfo(
            ...
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.53.0/src/phel/core/math.phel#L146",
                docs = "",
            ),
        ),
    ),
...
""",
            ...
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.53.0/src/phel/core/math.phel#L206",
                docs = "",
            ),
        ),
    ),
    PhelFunction(
        ...
        documentation = DocumentationInfo(
            ...
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.53.0/src/phel/core/math.phel#L108",
                docs = "",
            ),
        ),
    ),
...
""",
            ...
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.53.0/src/phel/core/math.phel#L642",
                docs = "",
            ),
        ),
    ),
...
""",
            ...
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.53.0/src/phel/core/math.phel#L1058",
                docs = "",
            ),
        ),
    ),
...
""",
            example = "(char 65) ; =&gt; \"A\"\n(char 32) ; =&gt; \" \"\n(char \\A) ; =&gt; \"A\"",
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.53.0/src/phel/core/math.phel#L649",
                docs = "",
            ),
        ),
    ),
...
""",
            ...
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.53.0/src/phel/core/math.phel#L803",
                docs = "",
            ),
        ),
    ),
...
""",
            example = "(dec 5) ; =&gt; 4",
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.53.0/src/phel/core/math.phel#L377",
                docs = "",
            ),
        ),
    ),
...
""",
            example = "(dec' 1) ; =&gt; 0",
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.53.0/src/phel/core/math.phel#L426",
                docs = "",
            ),
        ),
    ),
...
""",
            ...
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.53.0/src/phel/core/math.phel#L876",
                docs = "",
            ),
        ),
    ),
...
""",
            ...
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.53.0/src/phel/core/math.phel#L920",
                docs = "",
            ),
        ),
    ),
...
""",
            ...
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.53.0/src/phel/core/math.phel#L606",
                docs = "",
            ),
        ),
    ),
...
""",
            example = "(even? 4) ; =&gt; true",
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.53.0/src/phel/core/math.phel#L434",
                docs = "",
            ),
        ),
    ),
...
""",
            ...
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.53.0/src/phel/core/math.phel#L710",
                docs = "",
            ),
        ),
    ),
...
""",
            example = "(float 1) ; =&gt; 1.0\n(float 1/2) ; =&gt; 0.5",
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.53.0/src/phel/core/math.phel#L587",
                docs = "",
            ),
        ),
    ),
...
""",
            ...
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.53.0/src/phel/core/math.phel#L1043",
                docs = "",
            ),
        ),
    ),
    PhelFunction(
        ...
        signature = "(gcd a b)",
        completion = CompletionInfo(
            tailText = "Returns the greatest common divisor of a and b, computed with the Euclidean algorithm",
            priority = PhelCompletionPriority.CORE_FUNCTIONS,
        ),
        documentation = DocumentationInfo(
            summary = """
Returns the greatest common divisor of <code>a</code> and <code>b</code>, computed with the<br />
  Euclidean algorithm. The result is always non-negative; <code>(gcd 0 0)</code> is <code>0</code>.
""",
            example = "(gcd 12 18) ; =&gt; 6\n(gcd -12 18) ; =&gt; 6",
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.53.0/src/phel/core/math.phel#L537",
                docs = "",
            ),
        ),
    ),
...
""",
            example = "(inc 1) ; =&gt; 2",
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.53.0/src/phel/core/math.phel#L369",
                docs = "",
            ),
        ),
    ),
...
""",
            example = "(inc' 1) ; =&gt; 2",
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.53.0/src/phel/core/math.phel#L418",
                docs = "",
            ),
        ),
    ),
...
""",
            ...
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.53.0/src/phel/core/math.phel#L512",
                docs = "",
            ),
        ),
    ),
    PhelFunction(
        ...
        completion = CompletionInfo(
            tailText = "Checks if x is positive or negative infinity",
            priority = PhelCompletionPriority.PREDICATE_FUNCTIONS,
        ),
        documentation = DocumentationInfo(
            summary = """
Checks if <code>x</code> is positive or negative infinity. Alias for <code>inf?</code>, matching Clojure's <code>infinite?</code> naming.
""",
            example = "(infinite? php/INF) ; =&gt; true\n(infinite? 1.0) ; =&gt; false",
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.53.0/src/phel/core/math.phel#L519",
                docs = "",
            ),
        ),
    ),
...
""",
            example = "(int 1.9) ; =&gt; 1\n(int \"42\") ; =&gt; 42\n(int 1/10) ; =&gt; 0",
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.53.0/src/phel/core/math.phel#L560",
                docs = "",
            ),
        ),
    ),
    PhelFunction(
        ...
        signature = "(lcm a b)",
        completion = CompletionInfo(
            tailText = "Returns the least common multiple of a and b",
            priority = PhelCompletionPriority.CORE_FUNCTIONS,
        ),
        documentation = DocumentationInfo(
            summary = """
Returns the least common multiple of <code>a</code> and <code>b</code>. The result is always<br />
  non-negative; when either argument is zero the result is <code>0</code>.
""",
            example = "(lcm 4 6) ; =&gt; 12\n(lcm -4 6) ; =&gt; 12",
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.53.0/src/phel/core/math.phel#L549",
                docs = "",
            ),
        ),
    ),
...
""",
            example = "(long 1.9) ; =&gt; 1",
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.53.0/src/phel/core/math.phel#L613",
                docs = "",
            ),
        ),
    ),
...
""",
            example = "(max 3 1 2) ; =&gt; 3",
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.53.0/src/phel/core/math.phel#L748",
                docs = "",
            ),
        ),
    ),
...
""",
            ...
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.53.0/src/phel/core/math.phel#L789",
                docs = "",
            ),
        ),
    ),
...
""",
            ...
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.53.0/src/phel/core/math.phel#L836",
                docs = "",
            ),
        ),
    ),
...
""",
            ...
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.53.0/src/phel/core/math.phel#L843",
                docs = "",
            ),
        ),
    ),
...
""",
            example = "(min 3 1 2) ; =&gt; 1",
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.53.0/src/phel/core/math.phel#L721",
                docs = "",
            ),
        ),
    ),
...
""",
            ...
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.53.0/src/phel/core/math.phel#L775",
                docs = "",
            ),
        ),
    ),
...
""",
            example = "(mod 7 3) ; =&gt; 1\n(mod -7 3) ; =&gt; 2",
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.53.0/src/phel/core/math.phel#L339",
                docs = "",
            ),
        ),
    ),
...
""",
            example = "(nan? ##NaN) ; =&gt; true",
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.53.0/src/phel/core/math.phel#L496",
                docs = "",
            ),
        ),
    ),
...
""",
            example = "(neg? -2) ; =&gt; true",
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.53.0/src/phel/core/math.phel#L486",
                docs = "",
            ),
        ),
    ),
...
""",
            ...
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.53.0/src/phel/core/math.phel#L900",
                docs = "",
            ),
        ),
    ),
...
""",
            example = "(odd? 3) ; =&gt; true",
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.53.0/src/phel/core/math.phel#L445",
                docs = "",
            ),
        ),
    ),
...
""",
            example = "(one? 1) ; =&gt; true",
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.53.0/src/phel/core/math.phel#L467",
                docs = "",
            ),
        ),
    ),
...
""",
            example = "(pos? 3) ; =&gt; true",
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.53.0/src/phel/core/math.phel#L474",
                docs = "",
            ),
        ),
    ),
...
""",
            example = "(quot 7 3) ; =&gt; 2\n(quot -7 3) ; =&gt; -2",
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.53.0/src/phel/core/math.phel#L323",
                docs = "",
            ),
        ),
    ),
...
""",
            example = "(rand) ; =&gt; 0.42\n(rand 100) ; =&gt; 73.2",
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.53.0/src/phel/core/math.phel#L677",
                docs = "",
            ),
        ),
    ),
...
""",
            ...
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.53.0/src/phel/core/math.phel#L686",
                docs = "",
            ),
        ),
    ),
    PhelFunction(
        ...
        documentation = DocumentationInfo(
            ...
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.53.0/src/phel/core/math.phel#L693",
                docs = "",
            ),
        ),
    ),
    PhelFunction(
        namespace = "core",
        name = "random-sample",
        signature = "(random-sample prob)\n(random-sample prob coll)",
        completion = CompletionInfo(
            tailText = "Returns the items of coll for which (rand) is less than prob, so each item is kept independently ...",
            priority = PhelCompletionPriority.CORE_FUNCTIONS,
        ),
        documentation = DocumentationInfo(
            summary = """
...
""",
            ...
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.53.0/src/phel/core/math.phel#L701",
                docs = "",
            ),
        ),
    ),
...
""",
            ...
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.53.0/src/phel/core/math.phel#L987",
                docs = "",
            ),
        ),
    ),
...
""",
            example = "(rem 7 3) ; =&gt; 1\n(rem -7 3) ; =&gt; -1",
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.53.0/src/phel/core/math.phel#L331",
                docs = "",
            ),
        ),
    ),
...
""",
            ...
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.53.0/src/phel/core/math.phel#L1073",
                docs = "",
            ),
        ),
    ),
...
""",
            ...
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.53.0/src/phel/core/math.phel#L635",
                docs = "",
            ),
        ),
    ),
...
""",
            ...
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.53.0/src/phel/core/math.phel#L1084",
                docs = "",
            ),
        ),
    ),
...
""",
            example = "(sum [1 2 3]) ; =&gt; 6",
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.53.0/src/phel/core/math.phel#L812",
                docs = "",
            ),
        ),
    ),
    PhelFunction(
        ...
        signature = "(unsigned-bit-shift-right x n)",
        completion = CompletionInfo(
            tailText = "Bitwise shift right without sign extension: the vacated high bits are filled with zeros rather th...",
            priority = PhelCompletionPriority.CORE_FUNCTIONS,
        ),
        documentation = DocumentationInfo(
            summary = """
Bitwise shift right without sign extension: the vacated high bits are filled with zeros rather than copies of the sign bit. Unlike <code>bit-shift-right</code>, <code>(unsigned-bit-shift-right -1 10)</code> is a large positive number, not <code>-1</code>.
""",
            example = "(unsigned-bit-shift-right -1 10) ; =&gt; 18014398509481983",
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.53.0/src/phel/core/math.phel#L155",
                docs = "",
            ),
        ),
    ),
...
""",
            example = "(zero? 0) ; =&gt; true",
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.53.0/src/phel/core/math.phel#L456",
                docs = "",
            ),
        ),
    )
