...
internal fun registerCoreExceptionsFunctions(): List<PhelFunction> = listOf(
    PhelFunction(
        ...
        documentation = DocumentationInfo(
            ...
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.52.0/src/phel/core/exceptions.phel#L35",
                docs = "",
            ),
        ),
    ),
    PhelFunction(
        ...
        documentation = DocumentationInfo(
            ...
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.52.0/src/phel/core/exceptions.phel#L20",
                docs = "",
            ),
        ),
    ),
    PhelFunction(
        ...
        documentation = DocumentationInfo(
            ...
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.52.0/src/phel/core/exceptions.phel#L11",
                docs = "",
            ),
        ),
    ),
    PhelFunction(
        ...
        documentation = DocumentationInfo(
            ...
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.52.0/src/phel/core/exceptions.phel#L28",
                docs = "",
            ),
        ),
    )
