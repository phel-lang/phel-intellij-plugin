...
""",
            ...
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.52.0/src/phel/core/loops.phel#L16",
                docs = "",
            ),
        ),
    ),
...
""",
            ...
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.52.0/src/phel/core/loops.phel#L8",
                docs = "",
            ),
        ),
    ),
    PhelFunction(
        ...
        completion = CompletionInfo(
            tailText = "Repeatedly evaluates body (for side effects) as long as test is logical true",
            priority = PhelCompletionPriority.MACROS,
        ),
        documentation = DocumentationInfo(
            summary = """
Repeatedly evaluates <code>body</code> (for side effects) as long as <code>test</code> is logical true. Returns nil.
""",
            example = "(while (pos? @counter) (swap! counter dec))",
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.52.0/src/phel/core/loops.phel#L25",
                docs = "",
            ),
        ),
    )
