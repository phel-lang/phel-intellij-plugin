 ...
 */
object PhelApiCompletions {
    private val FUNCTION_ICON = AllIcons.Nodes.Function
    private val PREDICATE_ICON = AllIcons.Nodes.Method
     ...
     */
    @JvmStatic
    fun addCoreFunctions(result: CompletionResultSet, element: PsiElement) {
        // Core data structure functions with context-aware ranking
        addFunctionWithContext(
            result,
            "count",
            "(count xs)",
        ...
        addFunctionWithContext(
            ...
            "get-in",
            "(get-in coll [k & ks])",
            "Returns the value in a nested data structure",
            FUNCTION_ICON,
            element
        )
        addFunctionWithContext(
            ...
            "put",
            "(put coll key val)",
            "Returns a new collection with val added/updated at key",
            FUNCTION_ICON,
            element
        )
        addFunction(
        ...
        addFunction(
            ...
            "Updates a value by applying f to current element",
            FUNCTION_ICON
        )
        addFunction(
            result,
            "update-in",
            "(update-in coll [k & ks] f & args)",
            "Updates a value in nested data structure",
            FUNCTION_ICON
        )
        ...
        addFunction(
            ...
            "next",
            "(next coll)",
            "Returns collection without the first item, or nil if empty",
            FUNCTION_ICON
        )
        ...
        addFunction(
            ...
            "pop",
            "(pop coll)",
            "Returns collection with last item (vector) or first item (list) removed",
            FUNCTION_ICON
        )
        ...
        addFunction(
            ...
            "filter",
            "(filter pred xs)",
            "Returns collection of items for which pred returns true",
            FUNCTION_ICON
        )
        addFunction(
            result,
            "remove",
            "(remove pred xs)",
            "Returns collection of items for which pred returns false",
            FUNCTION_ICON
        )
        ...
        addFunction(
            ...
            "reduce2",
            "(reduce2 f init coll)",
            "Reduces collection using f with initial value",
            FUNCTION_ICON
        )
        addFunction(
            result,
            "keep",
            "(keep pred xs)",
            "Returns collection of non-nil results of pred applied to items",
            FUNCTION_ICON
        )
        addFunction(
            result,
            ...
            "Like keep but pred takes index and item",
            FUNCTION_ICON
        )
        ...
        addFunction(
            ...
            "partial",
            "(partial f & args)",
            "Returns function with args partially applied",
            FUNCTION_ICON
        )
        ...
        addFunction(
            ...
            "complement",
            "(complement f)",
            "Returns function that returns opposite boolean of f",
            FUNCTION_ICON
        )
        ...
        addFunction(
            ...
            "print-str",
            "(print-str & args)",
            "Returns string representation of args separated by spaces",
            FUNCTION_ICON
        )
        ...
        addFunction(
            ...
            "persistent",
            "(persistent tcoll)",
            "Returns persistent version of transient",
            FUNCTION_ICON
        )
        ...
        addFunction(
            ...
            "drop-while",
            "(drop-while pred xs)",
            "Returns collection after dropping while pred is true",
            FUNCTION_ICON
        )
        ...
        addFunction(
            ...
            "partition",
            "(partition n xs)",
            "Returns collection partitioned into chunks of size n",
            FUNCTION_ICON
        )
        ...
        addFunction(
            ...
            "extreme",
            "(extreme order args)",
            "Returns extreme value using order function",
            FUNCTION_ICON
        )
        ...
        addFunction(
            ...
            "dedupe",
            "(dedupe xs)",
            "Returns collection with consecutive duplicates removed",
            FUNCTION_ICON
        )
        ...
        addFunction(
            ...
            "every?",
            "(every? pred xs)",
            "Returns true if pred is true for every element",
            PREDICATE_ICON
        )
        ...
        addFunction(
            ...
            "mapcat",
            "(mapcat f & xs)",
            "Maps f over collections then concatenates results",
            FUNCTION_ICON
        )
        addFunction(
            result,
            "assoc",
            "(assoc ds key value)",
            "Associates key with value in data structure",
            FUNCTION_ICON
        )
        addFunction(
            result,
            "assoc-in",
            "(assoc-in ds ks v)",
            "Associates value in nested data structure",
            FUNCTION_ICON
        )
        ...
        addFunction(
            ...
            "dissoc-in",
            "(dissoc-in ds ks)",
            "Dissociates key from nested data structure",
            FUNCTION_ICON
        )
        ...
        addFunction(
            ...
            "Returns difference between two sets as pair",
            FUNCTION_ICON
        )
        ...
        addFunction(
            ...
            "Writes data to file, returning number of bytes written",
            FUNCTION_ICON
        )
     ...
     */
    @JvmStatic
    fun addPredicateFunctions(result: CompletionResultSet, element: PsiElement) {
     ...
     */
    @JvmStatic
    fun addCollectionFunctions(result: CompletionResultSet) {
        ...
        addFunction(
            ...
            "find-index",
            "(find-index pred xs)",
            "Returns index of first item matching pred",
            FUNCTION_ICON
        )
     ...
     */
    @JvmStatic
    fun addArithmeticFunctions(result: CompletionResultSet) {
    ...
    private fun addFunction(
        ...
        var priority = PhelCompletionRanking.Priority.API_FUNCTIONS
     ...
     */
    private fun addFunctionWithContext(
        result: CompletionResultSet,
        name: String,
        signature: String?,
        description: String?,
        ...
        val priority = PhelCompletionRanking.getContextualPriority(name, context, "API Function")
        PhelCompletionRanking.addRankedCompletion(result, name, priority, signature, description, icon)
    }
