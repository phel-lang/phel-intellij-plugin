 ...
 */
object PhelLanguageCompletions {
    private val SPECIAL_FORM_ICON = AllIcons.Nodes.Property
    private val MACRO_ICON = AllIcons.Nodes.AbstractMethod

    /**
     * Add Phel special forms
     */
    @JvmStatic
    fun addSpecialForms(result: CompletionResultSet) {
     ...
     */
    @JvmStatic
    fun addCoreMacros(result: CompletionResultSet) {
        // Threading macros
    ...
    private fun addSpecialForm(result: CompletionResultSet, name: String, signature: String?, description: String?) {
        // Special forms get high priority as they are core language constructs
        PhelCompletionRanking.addRankedCompletion(
            result, name, PhelCompletionRanking.Priority.SPECIAL_FORMS, signature, description, SPECIAL_FORM_ICON
        )
    }

    private fun addMacro(result: CompletionResultSet, name: String, signature: String?, description: String?) {
        // Macros get medium priority - less common than special forms but more than regular functions
        PhelCompletionRanking.addRankedCompletion(
            result, name, PhelCompletionRanking.Priority.MACROS, signature, description, MACRO_ICON
        )
    }
}
