...
""",
            ...
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.46.0/src/phel/schema.phel#L82",
                docs = "",
            ),
        ),
    ),
...
""",
            ...
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.46.0/src/phel/schema.phel#L89",
                docs = "",
            ),
        ),
    ),
...
""",
            ...
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.46.0/src/phel/schema.phel#L133",
                docs = "",
            ),
        ),
    ),
...
""",
            ...
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.46.0/src/phel/schema.phel#L65",
                docs = "",
            ),
        ),
    ),
...
""",
            ...
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.46.0/src/phel/schema.phel#L100",
                docs = "",
            ),
        ),
    ),
...
""",
            ...
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.46.0/src/phel/schema.phel#L74",
                docs = "",
            ),
        ),
    ),
...
""",
            ...
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.46.0/src/phel/schema.phel#L185",
                docs = "",
            ),
        ),
    ),
...
""",
            ...
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.46.0/src/phel/schema.phel#L198",
                docs = "",
            ),
        ),
    ),
...
""",
            example = null,
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.46.0/src/phel/schema.phel#L96",
                docs = "",
            ),
        ),
    ),
...
""",
            ...
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.46.0/src/phel/schema.phel#L119",
                docs = "",
            ),
        ),
    ),
...
""",
            ...
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.46.0/src/phel/schema.phel#L139",
                docs = "",
            ),
        ),
    ),
...
""",
            ...
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.46.0/src/phel/schema.phel#L108",
                docs = "",
            ),
        ),
    ),
...
""",
            ...
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.46.0/src/phel/schema.phel#L42",
                docs = "",
            ),
        ),
    ),
...
""",
            ...
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.46.0/src/phel/schema.phel#L149",
                docs = "",
            ),
        ),
    ),
...
""",
            ...
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.46.0/src/phel/schema.phel#L36",
                docs = "",
            ),
        ),
    ),
...
""",
            ...
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.46.0/src/phel/schema.phel#L48",
                docs = "",
            ),
        ),
    ),
...
""",
            ...
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.46.0/src/phel/schema.phel#L30",
                docs = "",
            ),
        ),
    ),
...
""",
            ...
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.46.0/src/phel/schema.phel#L156",
                docs = "",
            ),
        ),
    ),
...
""",
            ...
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.46.0/src/phel/schema.phel#L126",
                docs = "",
            ),
        ),
    ),
...
""",
            ...
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.46.0/src/phel/schema.phel#L192",
                docs = "",
            ),
        ),
    ),
...
""",
            ...
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.46.0/src/phel/schema.phel#L58",
                docs = "",
            ),
        ),
    ),
...
""",
            ...
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.46.0/src/phel/schema.phel#L163",
                docs = "",
            ),
        ),
    ),
...
""",
            ...
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.46.0/src/phel/schema.phel#L178",
                docs = "",
            ),
        ),
    ),
...
""",
            ...
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.46.0/src/phel/schema.phel#L171",
                docs = "",
            ),
        ),
    )
