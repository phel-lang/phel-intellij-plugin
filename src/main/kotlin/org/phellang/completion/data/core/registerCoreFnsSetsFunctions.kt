...
""",
            ...
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.39.0/src/phel/core/fns-sets.phel#L102",
                docs = "",
            ),
        ),
    ),
...
""",
            example = null,
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.39.0/src/phel/core/fns-sets.phel#L97",
                docs = "",
            ),
        ),
    ),
    PhelFunction(
        ...
        documentation = DocumentationInfo(
            ...
            example = null,
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.39.0/src/phel/core/fns-sets.phel#L286",
                docs = "",
            ),
        ),
    ),
    PhelFunction(
        ...
        documentation = DocumentationInfo(
            ...
            example = null,
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.39.0/src/phel/core/fns-sets.phel#L54",
                docs = "",
            ),
        ),
    ),
    PhelFunction(
        ...
        documentation = DocumentationInfo(
            ...
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.39.0/src/phel/core/fns-sets.phel#L249",
                docs = "",
            ),
        ),
    ),
...
""",
            ...
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.39.0/src/phel/core/fns-sets.phel#L140",
                docs = "",
            ),
        ),
    ),
    PhelFunction(
        ...
        documentation = DocumentationInfo(
            ...
            example = null,
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.39.0/src/phel/core/fns-sets.phel#L35",
                docs = "",
            ),
        ),
    ),
...
""",
            ...
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.39.0/src/phel/core/fns-sets.phel#L123",
                docs = "",
            ),
        ),
    ),
...
""",
            ...
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.39.0/src/phel/core/fns-sets.phel#L159",
                docs = "",
            ),
        ),
    ),
...
""",
            ...
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.39.0/src/phel/core/fns-sets.phel#L182",
                docs = "",
            ),
        ),
    ),
...
""",
            example = null,
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.39.0/src/phel/core/fns-sets.phel#L265",
                docs = "",
            ),
        ),
    ),
...
""",
            example = null,
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.39.0/src/phel/core/fns-sets.phel#L133",
                docs = "",
            ),
        ),
    ),
...
""",
            ...
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.39.0/src/phel/core/fns-sets.phel#L107",
                docs = "",
            ),
        ),
    ),
...
""",
            ...
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.39.0/src/phel/core/fns-sets.phel#L64",
                docs = "",
            ),
        ),
    ),
...
""",
            ...
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.39.0/src/phel/core/fns-sets.phel#L76",
                docs = "",
            ),
        ),
    ),
    PhelFunction(
        ...
        documentation = DocumentationInfo(
            ...
            example = null,
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.39.0/src/phel/core/fns-sets.phel#L59",
                docs = "",
            ),
        ),
    ),
...
""",
            example = null,
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.39.0/src/phel/core/fns-sets.phel#L231",
                docs = "",
            ),
        ),
    ),
    PhelFunction(
        ...
        documentation = DocumentationInfo(
            ...
            example = null,
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.39.0/src/phel/core/fns-sets.phel#L16",
                docs = "",
            ),
        ),
    ),
...
""",
            ...
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.39.0/src/phel/core/fns-sets.phel#L297",
                docs = "",
            ),
        ),
    ),
...
""",
            ...
            links = DocumentationLinks(
                github = "https://github.com/phel-lang/phel-lang/blob/v0.39.0/src/phel/core/fns-sets.phel#L307",
                docs = "",
            ),
        ),
    )
